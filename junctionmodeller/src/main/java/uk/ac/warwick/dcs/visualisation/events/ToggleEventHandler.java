package uk.ac.warwick.dcs.visualisation.events;

import javafx.stage.Popup;

import java.beans.EventHandler;

public class ToggleEventHandler<T extends Popup> extends EventHandler {
    /**
     ...
     */
    public ToggleEventHandler(Object target, String action, String eventPropertyName, String listenerMethodName) {
